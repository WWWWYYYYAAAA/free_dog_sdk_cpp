...
#local 192.168.123.12 go1 192.168.123.161p
# id: 0             q: -0.3094363510608673                  q_raw: 0.0
# id: 1             q: 1.2101929187774658                   q_raw: 0.0
# id: 2             q: -2.798168659210205                   q_raw: 0.0
# id: 3             q: 0.3273606598377228                   q_raw: 0.0
# id: 4             q: 1.1969918012619019                   q_raw: 0.0
# id: 5             q: -2.8097951412200928                  q_raw: 0.0
# id: 6             q: -0.32881397008895874                 q_raw: 0.0
# id: 7             q: 1.199474573135376                    q_raw: 0.0
# id: 8             q: -2.784402370452881                   q_raw: 0.0
# id: 9             q: 0.25318074226379395                  q_raw: 0.0
# id: 10            q: 1.060742974281311                    q_raw: 0.0
# id: 11            q: -2.8075344562530518                  q_raw: 0.0
    ...
    for paket in data:
        ...
        if motiontime % 100 == 0: #Print every 100 cycles
            ...
            for id in range(12):
                ...
                print(f'id: {id} \t\t  q: {lstate.motorState[id].q}  \t\t  q_raw: {lstate.motorState[id].q_raw}')
            print('+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=')
